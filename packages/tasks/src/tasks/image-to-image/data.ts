...
const taskData: TaskDataCustom = {
	...
	summary:
		"Image-to-image is the task of transforming an input image through a variety of possible manipulations and enhancements, such as super resolution, style transfer, colorization and more. Image-to-image pipelines can also be used in text-to-image tasks, where the input image can provide an additional visual guidance during the text-guided generation process.",
