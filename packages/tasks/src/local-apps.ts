...
const snippetUnsloth = (model: ModelData): LocalAppSnippet[] => {
	...
	const studio_instructions: LocalAppSnippet = {
		...
		content: ["# Run unsloth studio", "unsloth studio -H 0.0.0.0 -8080", "# Then open http://localhost:8000/chat in your browser" , "# Search for " + model.id + " to start chatting"].join("\n"),
	};
