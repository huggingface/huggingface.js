...
describe.skip("InferenceClient", () => {
	...
	describe.concurrent(
		"Consensus Protocol",
		() => {
			const client = new InferenceClient(env.HF_CONSENSUS_PROTOCOL_KEY ?? "dummy");

			HARDCODED_MODEL_INFERENCE_MAPPING["consensus-protocol"] = {
				"Qwen/Qwen3-Coder-30B-A3B-Instruct": {
					provider: "consensus-protocol",
					hfModelId: "Qwen/Qwen3-Coder-30B-A3B-Instruct",
					providerId: "qwen3-coder-30b",
					status: "live",
					task: "conversational",
				},
			};
