...
describe.skip("InferenceClient", () => {
	...
	describe.concurrent(
		"Nextbit",
		() => {
			const client = new InferenceClient(env.HF_NEXTBIT_KEY ?? "dummy");

			HARDCODED_MODEL_INFERENCE_MAPPING["nextbit"] = {
				"google/gemma-4-26b": {
					provider: "nextbit",
					hfModelId: "google/gemma-4-26b",
					providerId: "gemma4:26b-a4b",
					status: "live",
					task: "conversational",
				},
			};
