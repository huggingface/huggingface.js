...
import * as LambdaQ from "../providers/lambdaq.js";
...
export const PROVIDERS: Record<InferenceProvider, Partial<Record<InferenceTask, TaskProviderHelper>>> = {
	...
	lambdaq: {
		conversational: new LambdaQ.LambdaQConversationalTask(),
		"feature-extraction": new LambdaQ.LambdaQFeatureExtractionTask(),
		"text-generation": new LambdaQ.LambdaQTextGenerationTask(),
		"text-to-image": new LambdaQ.LambdaQTextToImageTask(),
		"text-to-speech": new LambdaQ.LambdaQTextToSpeechTask(),
	},
	novita: {
