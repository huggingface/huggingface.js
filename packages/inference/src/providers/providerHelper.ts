...
export interface VideoToVideoTaskHelper {
	getResponse(
		response: unknown,
		url?: string,
		headers?: HeadersInit,
	...
	preparePayload(params: BodyParams<VideoToVideoInput & BaseArgs>): Record<string, unknown>;
	preparePayloadAsync(args: VideoToVideoArgs): Promise<RequestArgs>;
}
