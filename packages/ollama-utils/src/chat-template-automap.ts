...
export const OLLAMA_CHAT_TEMPLATE_MAPPING: OllamaChatTemplateMapEntry[] = [
	...
	{
		"model": "library/deepseek-coder:6.7b",
	...
	{
		"model": "library/granite-code:34b",
	...
	{
		"model": "library/mistral-small:22b",
